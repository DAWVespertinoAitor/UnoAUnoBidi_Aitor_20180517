...
<html>
    ...
    <body>
        ...
        <div class="columnasCentradas">
            ...
            <form method="post" action="conclusion?op=updatePais">
                <table style="margin: 0 auto;">
                    <tr>
                        <th colspan="2">Datos Pais</th>
                    </tr>
                    <tr>
                        <td>Código</td>
                        <td><input type="text" name="id" value="${pais.id}" readonly="readonly" /></td>
                    </tr>
                    <tr>
                        <td>Nombre</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="nombrePresidente" value="${pais.presidente.nombrePresidente}"/></td>
                    </tr>
                </table><br>
